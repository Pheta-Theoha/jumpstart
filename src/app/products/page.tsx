...
export default function Products() {
  return (
    <main>
      <div className="products-header text-white text-shadow-lg outline-4">
        <h1 className="drop-shadow-[0_3px_3px_rgba(10,10,10,10)] text-6xl pt-40 pl-32">Our Products</h1>
      </div>
