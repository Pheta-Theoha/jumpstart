...
export default function Services() {
  return (
    <main>
      <div className="services-header text-white text-shadow-lg outline-4">
        <h1 className="drop-shadow-[0_3px_3px_rgba(10,10,10,10)] text-6xl pt-40 pl-20">Services We Offer</h1>
      </div>
